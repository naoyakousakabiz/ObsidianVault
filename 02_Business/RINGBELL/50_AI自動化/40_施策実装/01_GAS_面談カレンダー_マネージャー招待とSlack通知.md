...
**ファイル:** `50_業務自動化/40_施策実装/01_GAS_面談カレンダー_マネージャー招待とSlack通知.md`
**位置づけ:** **施策実装**（1ファイル＝1施策）。全体方針は `20_設計/Ringwell_CS_AI自動化設計.md`。業務整理・フレームは `10_業務整理/10_業務改善とAI導入_コンサル納品フレーム_RINGBELL用.md`。フォルダの意味は `02_フォルダ設計.md`。汎用テンプレ正本は `04_AI/04_テンプレート/`。
