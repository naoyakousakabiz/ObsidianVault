...
| ④ | チャエンのClaude Code完全まとめ | [Notion](https://www.notion.so/Claude-Code-MCP-3300c6378bf1818d8ee6d31464c0bc4f?pvs=21) ／ Markdown: [[ClaudeCode_チャエン完全まとめ_スキルMCPコマンド運用_20260328]] |
| ⑤ | セミナーレポート | [Notion](https://www.notion.so/Claude-Code-3320c6378bf180c38680e8eefcf0d1d2?pvs=21) |
| ⑥ | 質疑応答132問（スプレッドシート） | [Googleスプレッドシート](https://docs.google.com/spreadsheets/d/1B1nvYTss6CfEckhlMnE2jRwljZo8bI96siooRhUbAEo/edit?usp=sharing) ／ 同一内容のMarkdown: [[ClaudeCode_業務活用マスター講座_QA132問_20260329]] |
| ⑦ | バイブコーディング・マスターガイド | [Notion](https://www.notion.so/Claude-Code-3310c6378bf1811084d0f943779f384f?pvs=21) ／ Markdown: [[ClaudeCode_バイブコーディング完全マスター講座_概念からClaudeCodeまで]] |
| ⑧ | 30日勉強ロードマップ | [Notion](https://www.notion.so/30-Claude-Code-_20260329-3300c6378bf1814090c3e4efcf39bc3e?pvs=21) ／ Markdown: [[ClaudeCode_30日ロードマップ_最強ガイドブック_20260329]] |
...
9. **講座関連ソースは Vault に集約**  
   本レジュメに加え、次を同じ Vault（`04_AI/03_手法`）に格納済み。検索・バックリンクで横断参照できる。

   - [[ClaudeCode_業務活用マスター講座_QA132問_20260329]]（Q&A 132問）
   - [[ClaudeCode_30日ロードマップ_最強ガイドブック_20260329]]（30日ロードマップ）
   - [[ClaudeCode_バイブコーディング完全マスター講座_概念からClaudeCodeまで]]
   - [[ClaudeCode_チャエン完全まとめ_スキルMCPコマンド運用_20260328]]
